...
int main (int argc, char const * argv []) {
	...
	while (YES) {
		...
		switch (buffer->op) {
			case ADD: buffer->r = buffer->a + buffer->b;
				break;
			case SUB: buffer->r = buffer->a - buffer->b;
				break;
			case MUL: buffer->r = buffer->a * buffer->b;
				break;
			case DIV: buffer->r = buffer->a / buffer->b;
				break;
			case MOD: buffer->r = buffer->a / buffer->b;
				break;
			default:
				break;
		}
