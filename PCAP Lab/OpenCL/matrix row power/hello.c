...
int main (int argc, char** argv) {
    ...
    //
    mem_obj = clCreateBuffer(context, CL_MEM_READ_WRITE, sizeof(int) * M * N, NULL, NULL);
    if (!mem_obj) {
    ...
    //
    err = clEnqueueWriteBuffer(commands, mem_obj, CL_TRUE, 0, sizeof(int) * M * N, inpooot, 0, NULL, NULL);
    if (err != CL_SUCCESS) {
...
//		perror("--");
    ...
    //
    err = clEnqueueReadBuffer(commands, mem_obj, CL_TRUE, 0, sizeof(int) * M * N, outpoot, 0, NULL, NULL );
    if (err != CL_SUCCESS) {
