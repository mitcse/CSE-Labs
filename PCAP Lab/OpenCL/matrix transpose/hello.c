...
int main (int argc, char** argv) {
	...
	mem_output = clCreateBuffer(context, CL_MEM_WRITE_ONLY, sizeof(int) * N * M, NULL, NULL);
    if (!mem_input) {
...
//		perror("--");
    ...
    //
    err = clEnqueueReadBuffer(commands, mem_output, CL_TRUE, 0, sizeof(int) * N * M, outpoot, 0, NULL, NULL );
    if (err != CL_SUCCESS) {
