...
int main (int argc, char** argv) {
	...
	char *data = "This will Captalize all the Vowels";
	...
	mem_output = clCreateBuffer(context,  CL_MEM_WRITE_ONLY,  sizeof(char) * count, NULL, NULL);
	...
	err = clEnqueueReadBuffer(command_queue, mem_output, CL_TRUE, 0, sizeof(char) * count, results, 0, NULL, NULL );
